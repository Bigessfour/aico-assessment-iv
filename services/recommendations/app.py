"""Recommendations FastAPI wrapper around a SageMaker endpoint.
...
app = FastAPI(title="recommendations", version="0.1.0")
...
def predict(payload: dict, x_model_variant: Optional[str] = Header(default=None)):
    """Business path: forward JSON to the recommendations SageMaker endpoint.
